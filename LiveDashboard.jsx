...
const SECTION_CONFIG = {
  team: {
    ...
    max: 25, total: 130,
    tiers: [
      { label: "Starting Out",      color: "#ef4444", range: [26, 52] },
      { label: "Early Progress",    color: "#f59e0b", range: [53, 78] },
      { label: "Gaining Momentum",  color: "#3b82f6", range: [79, 104] },
      { label: "AI Advanced",       color: "#00BCD4", range: [105, 117] },
      { label: "AI Pioneer",        color: "#7c3aed", range: [118, 130] },
    ],
  },
  leader: {
    ...
    max: 25, total: 130,
    tiers: [
      { label: "Untapped Potential", color: "#ef4444", range: [26, 52] },
      { label: "Getting Started",    color: "#f59e0b", range: [53, 78] },
      { label: "Active Explorer",    color: "#3b82f6", range: [79, 104] },
      { label: "AI Advanced",        color: "#00BCD4", range: [105, 117] },
      { label: "AI Pioneer",         color: "#7c3aed", range: [118, 130] },
    ],
  },
  company: {
    ...
    max: 30, total: 130,
    tiers: [
      { label: "Not Yet",                range: [26, 51],   color: "#ef4444" },
      { label: "Groundwork Needed",      range: [52, 77],   color: "#f59e0b" },
      { label: "Ready to Start",         range: [78, 103],  color: "#3b82f6" },
      { label: "Ready to Accelerate",    range: [104, 117], color: "#00BCD4" },
      { label: "AI-Driven Organization", range: [118, 130], color: "#7c3aed" },
    ],
  },
};
