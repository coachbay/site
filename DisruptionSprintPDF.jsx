...
// ── Sub-components ─────────────────────────────────────────────────────────
function HeaderBand({ title, pageLabel, date }) {
  return (
    <View style={S.headerBand} fixed>
      <Text style={S.headerText}>COACHBAY.AI  ·  DISRUPTION SPRINT</Text>
      <Text style={S.headerText}>{pageLabel ? `${pageLabel}  ·  ` : ""}{date.toUpperCase()}</Text>
    </View>
  );
}
...
function Footer({ date }) {
  return (
    <View style={S.footer} fixed>
      <Text style={S.footerText}>coachbay.ai  ·  Generated by CoachBay</Text>
  ...
  return (
    <Document title={`Disruption Sprint — ${startupName}`} author="CoachBay">
      ...
      <Page size="A4" style={S.page}>
        <HeaderBand date={today} />
        <Footer date={today} />

        <View style={S.content}>
          <Text style={S.coverTitle}>Disruption Sprint Summary</Text>
      ...
      <Page size="A4" style={S.page}>
        <HeaderBand date={today} pageLabel="PAGE 2" />
        <Footer date={today} />
      ...
      <Page size="A4" style={S.page}>
        <HeaderBand date={today} pageLabel="PAGE 3" />
        <Footer date={today} />
