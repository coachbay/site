...
export const rolloutConfig = {
  ...
  tierData: [
    ...
    {
      range: [43, 55], label: "Gaps to Close", color: CYAN,
    ...
    {
      range: [27, 42], label: "Not Yet Ready", color: "#f59e0b",
