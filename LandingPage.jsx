...
const RobotIcon = ({ size = 72 }) => (
  <img src="/coachbay-robot-transparent.png" width={size} height={size} alt="CoachBay" />
);
        ...
        <div style={{ padding: "0 24px", marginTop: 28 }}>
          <div style={{
            ...
            <div style={{ flex: 1, minWidth: 240 }}>
              ...
              <h3 style={{ fontFamily: "'DM Serif Display', serif", fontSize: 26, color: "#f8fafc", margin: "0 0 8px" }}>Disruption Sprint</h3>
