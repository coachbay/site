        ...
        <div style={{ maxWidth: 1060, margin: "0 auto" }}>
          ...
          <div style={{ borderTop: "1px solid #e2e8f0", paddingTop: 48 }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 20 }} className="stories-grid">
              {[
                { moment: "She went straight to her boss and shared her insights.", story: "A senior leader was stuck on a major business challenge her team had been circling for months. We ran it through AI as a thinking partner in one conversation. She walked out and went directly to her boss to say they needed to move on this.", result: "New client engagement followed." },
                { moment: "He immediately aligned his team around AI.", story: "A GM came to me for coaching on a complex stakeholder management challenge. We cracked it open with AI in one session. He went straight back and restructured his team around AI, introducing weekly AI review meetings. Two weeks later, he bought his own MacBook to go deeper.", result: "One session. Organization-wide change." },
                { moment: "She sent me an email at 11pm.", story: "A commercial manager volunteered her team's biggest stuck problem during one of my workshops. By the end, genuinely new ideas were on the table. That evening at 11pm I received an email asking for the full session output.", result: "Immediate action. New thinking unlocked." },
              ].map((s, i) => (
