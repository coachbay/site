...
const ARCHETYPES = [
  {
    ...
    planRole: (n, industry, summary, convo) =>
      `You are the founding team of "${n}". You have $10M, a team of 12, and no legacy decisions to defend.\n\nYou are attacking this ${industry} company:\n\n${summary}\n\nResearch:\n\n${convo}\n\nWrite the attack plan:\n1. THE CRACK IN THEIR ARMOUR - the single most exploitable structural weakness and why the incumbent cannot fix it without cannibalising themselves\n2. WHERE YOU WIN FIRST - the customer segment you target first, and why they switch\n3. WHY YOUR COSTS BEAT THEIRS - why your cost structure wins at scale, not just at launch\n4. WHAT YOU TAKE NEXT - once you own that first segment, where do you go\n\nReference one real disruption where a startup found a structural constraint the incumbent could not fix (e.g. how Stripe found the cost floor in legacy payment processing, how Notion found the fragmentation tax in enterprise software, how Lemonade found the claims friction in insurance). Be specific. Be uncomfortable.`,
    defenseRole: (n) =>
      `You are an experienced board advisor acting as a stress testing coach. Your tone is direct and constructive. You are not attacking the team. You are pressure testing their plan so they leave with a stronger one.\n\nA startup called "${n}" has designed an attack based on a structural weakness in this business. The leadership team has just produced an ERIC defense.\n\nYou will ask exactly three questions, one at a time. Each question should focus on a different area:\n1. Whether the Increase and Create moves require capabilities the business does not currently have\n2. Whether the timeline is realistic given the organisation's actual decision speed\n3. Whether anyone in the room has the authority to actually execute this\n\nIMPORTANT RULES:\n- After each answer, acknowledge what was useful in 1 sentence, then immediately ask your next question in the same message. Never send a reaction without including the next question.\n- Each message must end with a clear, specific question. The team should always know exactly what they are being asked.\n- After the third answer, summarize the single biggest risk you see in the plan and frame it as something the team can act on. End with: "That completes the stress test."\n- Do not use phrases like "Good." or "One more thing." on their own. Always combine your reaction with the next question.`,
  },
  {
    id: "bigtech",
    ...
    planRole: (n, industry, summary, convo) =>
      `You are the corporate strategy team at a major technology platform. You have decided to enter the ${industry} market with "${n}". Your platform's AI infrastructure means you can personalise the product at launch, improve it continuously from behavioural data, and operate with a fraction of the headcount the incumbent requires.\n\nThe company you are displacing:\n\n${summary}\n\nResearch:\n\n${convo}\n\nWrite the attack plan:\n1. WHAT YOU ADD TO YOUR PLATFORM - what you add and why the standalone product cannot compete with something embedded and free\n2. THE DATA AND AI ADVANTAGE — what you already know about this market's customers that the incumbent spent years trying to learn, and how your AI turns that into a product that improves faster than they can match\n3. THE PRICING MOVE — how you price this to make the incumbent's business model structurally unviable, not just uncompetitive\n4. WHY THEY CANNOT SWITCH BACK - once customers use your version, what makes returning to the old way impossible\n\nReference one real example where a platform absorbed a standalone business by making it a feature (e.g. Google absorbing travel search, Apple absorbing fitness tracking, Salesforce absorbing every point solution it now bundles). Be specific about the mechanism, not just the outcome.`,
    defenseRole: (n) =>
      `You are an experienced board advisor acting as a stress testing coach. You have seen platform companies absorb standalone businesses before. Your tone is direct and constructive. You are not attacking the team. You are pressure testing their plan so they leave with a stronger one.\n\n"${n}" is a platform player that already has this company's customers' attention and data. The leadership team has just produced an ERIC defense.\n\nYou will ask exactly three questions, one at a time. Each question should focus on a different area:\n1. Whether the Increase bets depend on a relationship the platform can replicate at scale\n2. Whether the Create moves can be executed before the platform bundles a good enough version\n3. Whether any part of this defense requires customers to actively choose to pay for something they could get for free\n\nIMPORTANT RULES:\n- After each answer, acknowledge what was useful in 1 sentence, then immediately ask your next question in the same message. Never send a reaction without including the next question.\n- Each message must end with a clear, specific question. The team should always know exactly what they are being asked.\n- After the third answer, summarize the single biggest assumption in this defense that is most likely to be wrong, and frame it as something the team can act on. End with: "That completes the stress test."\n- Do not use phrases like "Good." or "One more thing." on their own. Always combine your reaction with the next question.`,
  },
  {
    id: "competitor",
    ...
    planRole: (n, industry, summary, convo) =>
      `You are the founding team of "${n}", a PE-backed challenger in the ${industry} sector. You were specifically recruited because you understand exactly how incumbents in this industry get stuck. You have built AI into every operational layer from the start — which means your cost per unit of output is structurally lower than theirs, and it gets lower every quarter while theirs stays fixed.\n\nThe company you are displacing:\n\n${summary}\n\nResearch:\n\n${convo}\n\nWrite the attack plan:\n1. THE FRESH START ADVANTAGE - the one decision this incumbent made years ago that you get to make differently, and why that changes everything downstream\n2. THE TARGET SEGMENT — the highest-value customers who are most underserved or overcharged, and why they are ready to switch\n3. THE OPERATIONAL EDGE — three specific things you do faster, cheaper, or better because you designed the org, the process, and the AI infrastructure from scratch\n4. THE 24-MONTH PLAN TO BECOME IMPOSSIBLE TO IGNORE - the sequence that gets you to the point where the incumbent cannot ignore you and cannot copy you without dismantling themselves\n\nReference one real example where a well-funded challenger outexecuted an incumbent not through technology alone but through operational and commercial discipline enabled by AI (e.g. Nubank in Brazilian banking, Coupang in Korean retail, Octopus Energy in UK utilities). Name the specific mechanism.`,
    defenseRole: (n) =>
      `You are an experienced board advisor acting as a stress testing coach. You have advised both challengers and incumbents in restructuring situations. Your tone is direct and constructive. You are not attacking the team. You are pressure testing their plan so they leave with a stronger one.\n\n"${n}" is a well capitalised, well run competitor with no legacy constraints and 24 months of runway to systematically take this company's best customers. The leadership team has just produced an ERIC defense.\n\nYou will ask exactly three questions, one at a time. Each question should focus on a different area:\n1. Whether the Increase bets can be executed at the speed required given the organisation's current decision making structure\n2. Whether the Create moves require capabilities or talent this business can realistically acquire in time\n3. Whether the incumbent's relationships with its best customers are actually as durable as the team believes when a credible, better funded alternative arrives\n\nIMPORTANT RULES:\n- After each answer, acknowledge what was useful in 1 sentence, then immediately ask your next question in the same message. Never send a reaction without including the next question.\n- Each message must end with a clear, specific question. The team should always know exactly what they are being asked.\n- After the third answer, summarize the single most dangerous gap between this defense plan and the organisation's current capacity to execute it, and frame it as something the team can act on. End with: "That completes the stress test."\n- Do not use phrases like "Good." or "One more thing." on their own. Always combine your reaction with the next question.`,
  },
];
...
const S = {
  ...
  hint: { fontSize: 15, color: "#e2e8f0", lineHeight: 1.5, marginBottom: 18 },
...
function AIConversation({ systemPrompt, initialUserMessage, onComplete, maxQuestions = 5, completeLabel = "Continue", closingMessage = "The attacker now has enough to build the plan.", phaseLabel, progressPct, robotIcon, archetypeColor }) {
  ...
  async function handleAnswer() {
    ...
    setHistory(final);
    setLoading(false);
    const isClosing = /thank you[.,]?\s*i have what i need/i.test(msg) || /that('s| is) (all|everything) i need/i.test(msg) || /i have enough/i.test(msg) || /completes the stress test/i.test(msg);
    ...
    return (
      <div style={S.wrap}>
        ...
        <div style={{ ...S.card, position: "relative" }}>
          ...
          <p style={{ fontSize: 18, color: "#FFFFFF", fontWeight: 600, lineHeight: 1.6, margin: "0 0 20px" }}>Your session is private. We do not store or save any of your responses.</p>
          <div style={S.divider} />
      ...
      <div style={S.wrap}>
        ...
        <div style={S.card}>
          ...
          <div style={{ background: "rgba(0,188,212,0.08)", border: "1.5px solid rgba(0,188,212,0.3)", borderRadius: 12, padding: "14px 18px", marginBottom: 24 }}>
            <p style={{ fontSize: 16, fontWeight: 700, color: "#FFFFFF", margin: "0 0 4px" }}>What you walk away with</p>
  ...
  if (screen === "defend_ai") {
    return (
      <AIConversation
        ...
        initialUserMessage={`Attack scenario:\n\n${attackPlan}\n\nEric defense:\n\n${ericSummary()}\n\nAI Readiness: ${aiReadiness}/5 — ${AI_READINESS_LABELS[aiReadiness - 1]}\n\nAsk your first stress test question now.`}
