...
# Generates /public/CoachBay_Debate_Voices_SPROPS.pdf using ReportLab.
# Swire Properties handout. Tuned with Swire specific roles, names, and places.
...
def draw_title_block(c, y):
    ...
    c.drawString(MARGIN, y - 6 * mm, "4D Debate phase. Tuned for Swire Properties.")
...
VOICES = [
    {
        "name": "1. Experienced EXCOM member",
        "lens": "Brand, reputation, and whether this is worthy of the Swire name.",
        "prompt": ("You are a long serving Swire Properties EXCOM member. You have seen "
                   "initiatives come and go over twenty years. You care deeply about the "
                   "Swire name and the standard it represents. You are not easily impressed "
                   "by new technology. Review the proposal above as that person. Give us "
                   "three reasons you would turn this proposal down today, and for each one "
                   "explain what we could do to change your mind. Finish by telling us the "
                   "one thing in this proposal that would make you proud if we got it right."),
    },
    {
        "name": "2. Skeptical CFO",
        "lens": "Capital, cost, return, and opportunity cost.",
        "prompt": ("You are the CFO of Swire Properties. You think in long cycle property "
                   "economics, not quarterly tech spend. You want real numbers, not vague "
                   "benefits. Review the proposal above as that person. Tell us what numbers "
                   "you would need to see before you could approve this. Then list the three "
                   "financial risks that concern you most and what you would need to see to "
                   "be satisfied that each one is managed. Finish with the one commercial "
                   "condition you would attach to an approval."),
    },
    {
        "name": "3. Front line employee",
        "lens": "Can this actually be done on the ground, with the time and people available.",
        "prompt": ("You are a property manager or building operations lead at Taikoo Place "
                   "or Pacific Place. You already have a full plate of tenant requests, "
                   "safety checks, and daily operations. Review the proposal above as that "
                   "person. Tell us what you like about it, what you do not like, and what "
                   "you would change so it works on the ground. Then describe what a typical "
                   "Monday morning looks like after this is rolled out, and where it could "
                   "go wrong. Explain your reasoning throughout."),
    },
    {
        "name": "4. Demanding tenant",
        "lens": "The experience of a premium tenant paying top of market rent.",
        "prompt": ("You are the Hong Kong head of a multinational leasing a full floor at "
                   "One Taikoo Place, or the regional director of a luxury brand at Pacific "
                   "Place. You pay premium rent and expect premium service. Review the "
                   "proposal above as that person. Tell us what you like, what you do not "
                   "like, and what you would change. Then tell us whether this would make "
                   "you renew your lease at a higher rent, stay the same, or quietly start "
                   "looking elsewhere. Explain your reasoning throughout."),
    },
    {
        ...
        "prompt": ("You are a tough, experienced executive who has seen similar initiatives "
                   "fail inside large Hong Kong conglomerates. You are not trying to kill "
                   "the idea. You are trying to make it bulletproof. Review the proposal "
                   "above as that person. Name the three weakest points in the plan. For "
                   "each one, explain why it could cause the plan to fail and what would "
                   "need to be true for the plan to survive it. Finish with the one "
                   "assumption in this plan that you would bet against."),
    },
    {
        "name": "6. Competitor",
        "lens": "What a rival landlord would do in response.",
        "prompt": ("You are the strategy lead at Hongkong Land, Sun Hung Kai, or Henderson "
                   "Land. You have just learned that Swire Properties is making this move. "
                   "Review the proposal above as that person. Tell us what you would do in "
                   "response. Where do you see the opening? What is your counter move? And "
                   "if you chose not to respond at all, what would be your reasoning? "
...
def build():
    out_path = "public/CoachBay_Debate_Voices_SPROPS.pdf"
    c = canvas.Canvas(out_path, pagesize=A4)

    draw_header(c, "DEBATE VOICES  |  SWIRE PROPERTIES")
    draw_footer(c)
